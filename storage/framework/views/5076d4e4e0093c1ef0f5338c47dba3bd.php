<?php $__env->startSection('content'); ?>
    ...
    <div class="my-5 px-4 py-5 text-center">
        <img class="d-block mx-auto mb-4" src="<?php echo e(asset('storage/logopng.png')); ?>" alt="" width="72" height="57">
        <h3 class="bold"><?php echo e(auth()->user()->name); ?></h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#myModal<?php echo e($room->id); ?>">
                                        Code Qr
                                    </button>

                                    <!-- The Modal -->
                                    <div class="modal" id="myModal<?php echo e($room->id); ?>">
                                        <div class="modal-dialog d-flex justify-content-center align-items-center">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <?php echo QrCode::size(200)->generate(url("qrcode/{$room->code_QR}")); ?>

                                                    <br>
                                                    <br>
                                                    <b class="p-1"><?php echo e($room->nama_kamar); ?></b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('templates.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Documents\PROJECT LARAVEL\HomeStay V2 - Copy\resources\views/v_user/index.blade.php ENDPATH**/ ?>